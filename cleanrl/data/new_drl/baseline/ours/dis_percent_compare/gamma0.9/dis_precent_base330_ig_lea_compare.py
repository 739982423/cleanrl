...
igniter_dis_percent_matrix = [
                                    ...
                                    [80,0.021452835,0.040773281,0.045167413,0]
                                  ]

min_workload_dis_percent_matrix = [
                                    [0,0.0,0.00171425719935,0.012002323030263922,0.0],
                                    [80,0.03573943749286,0.066949286345838073,0.09977972629431733,0.0]
                             ]
...
for mode in ["wlstm", "wolstm"]:
    ...
    for idx, m in enumerate(file_model_names):
        ...
        for csv in files:
            if csv[-4:] != ".csv":
                continue
            df = pd.read_csv("./{}/{}/{}/{}".format(mode, "base330", m, csv))
...
plt.savefig("./base330_{}_dis_precent_ig_le_compare_1M.pdf".format(model_name))
plt.savefig("./base330_{}_dis_precent_ig_le_compare_1M.png".format(model_name))
plt.show()
print("-------------------------------")
