...
min_workload_dis_percent_matrix = [
                                    ...
                                    [80,0.0,0.053452065176203107,0.06760302020063631,0.0],
...
igniter_dis_percent_matrix = [
                                ...
                                [80,0.0,0.0073841101427308324,0.050757470581967085,0.0],
                                [180,0.0207544572836977,0.0575290830814326,0.0668059225563323,0.0]
                             ]
...
# ------------------ 这里是要修改的baseline部分 --------------------
    ax[r][c].hlines(xmin=0, xmax=208, y=min_workload_dis_percent_matrix[5][idx + 1], label="Least Loaded", linestyles=":", colors='violet',lw=2)
    ax[r][c].hlines(xmin=0, xmax=208, y=igniter_dis_percent_matrix[5][idx + 1], label="IGniter+", linestyles="--", colors='k',lw=2)
# -------------------------------------------------------------------
...
plt.savefig("./base360_{}_dis_precent_ig_le_compare_400k.pdf".format(model_name))
plt.savefig("./base360_{}_dis_precent_ig_le_compare_400k.png".format(model_name))
plt.show()
print("-------------------------------")
