...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="GPUcluster-1a_p_4m_2g_32b",
...
def make_env(env_id, seed, idx, capture_video, run_name):
    def thunk():
        env = gym.make(env_id, discard_cost_alpha = args.discard_alpha, load_cost_alpha = args.load_alpha, input_ascend = args.input_ascend)
...
if __name__ == "__main__":
    ...
    run_name = f"{args.env_id}__{args.exp_name}__{args.seed}__{res_file_name}__gamma{args.gamma}__loadalpha{args.load_alpha}"
    ...
    #创建tensorboard存储对象
    storefile = "runs_2g_tweet_input_32b_2"
    writer = SummaryWriter(f"{storefile}/{run_name}")
    ...
    torch.save(agent, r"./{}/{}/a1.pt".format(storefile, run_name))
